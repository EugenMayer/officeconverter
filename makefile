...
start: stop
	docker run -m 512m --name converter-dev --rm -p 8080:8080 eugenmayer/converter:development

start-prod: stop
	docker run -m 512m --name converter-prod --rm -p 8080:8080 eugenmayer/converter:production
